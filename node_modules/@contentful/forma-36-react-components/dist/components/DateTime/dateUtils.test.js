...
describe('formatMachineReadableDateTime', function () {
  it('formats with the expected values', function () {
    var date = new Date('2020-02-29T09:31:46.345Z');
    var formatToExpected = [['FULL', '2020-02-29T09:31:46.345Z'], ['DATE_ONLY', '2020-02-29'], ['TIME_ONLY', '09:31:46.345'], ['WEEKDAY_DATE', '02-29']];
    formatToExpected.forEach(function (_ref3) {
      var _ref4 = (0, _slicedToArray2["default"])(_ref3, 2),
          format = _ref4[0],
          expected = _ref4[1];

      expect(dateUtils.formatMachineReadableDateTime(date, format)).toEqual(expected);
    });
  });
});
...
describe('formatRelativeDateTime', function () {
  it('formats with the expected values', function () {
    ...
    dateToExpected.forEach(function (_ref7) {
