...
export declare const Flex: ({ alignItems, alignSelf, children, className, flexDirection, flexGrow, flexWrap, fullHeight, fullWidth, htmlTag: Container, inlineFlex, justifyContent, justifyItems, justifySelf, margin, marginBottom, marginLeft, marginRight, marginTop, noShrink, padding, paddingBottom, paddingLeft, paddingRight, paddingTop, style, testId, ...otherProps }: FlexProps) => JSX.Element;
