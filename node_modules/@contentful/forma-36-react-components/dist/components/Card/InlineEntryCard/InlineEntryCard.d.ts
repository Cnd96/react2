...
export declare function InlineEntryCard({ className, dropdownListElements, isSelected, children, testId, isLoading, status, href, ...otherProps }: InlineEntryCardPropTypes): React.ReactElement;
