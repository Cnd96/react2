...
export declare function EmptyState({ className, children, testId, customImageElement, imageProps, headingProps, descriptionProps, ...otherProps }: EmptyStateProps): React.ReactElement;
export {};
