...
export declare function Modal({ allowHeightOverflow, position, shouldCloseOnEscapePress, shouldCloseOnOverlayClick, size, testId, topOffset, ...otherProps }: ModalProps): React.ReactElement;
export declare namespace Modal {
    var Header: typeof ModalHeader;
    var Content: typeof ModalContent;
    var Controls: typeof ModalControls;
    var defaultProps: {
        allowHeightOverflow: boolean;
        position: string;
        shouldCloseOnEscapePress: boolean;
