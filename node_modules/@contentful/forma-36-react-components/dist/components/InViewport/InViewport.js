...
var _excluded = ["className", "children", "testId", "onOverflowBottom", "onOverflowLeft", "onOverflowRight", "onOverflowTop"];
...
var InViewport = /*#__PURE__*/function (_Component) {
  ...
  function InViewport() {
    ...
    _this.tOnOverflowTop = _this.props.onOverflowTop && (0, _throttle.throttle)(100, _this.props.onOverflowTop);
    _this.tOnOverflowBottom = _this.props.onOverflowBottom && (0, _throttle.throttle)(100, _this.props.onOverflowBottom);
    _this.tOnOverflowRight = _this.props.onOverflowRight && (0, _throttle.throttle)(100, _this.props.onOverflowRight);
    _this.tOnOverflowLeft = _this.props.onOverflowLeft && (0, _throttle.throttle)(100, _this.props.onOverflowLeft);

    _this.getDomPosition = function () {
      if (_isBrowser.isBrowser && _this.nodeRef) {
    ...
    _this.bindEventListeners = function () {
      _this.tGetDomPosition = (0, _throttle.throttle)(600, _this.getDomPosition);
  ...
  (0, _createClass2["default"])(InViewport, [{
    ...
    value: function componentWillUnmount() {
      if (_isBrowser.isBrowser && this.tGetDomPosition) {
