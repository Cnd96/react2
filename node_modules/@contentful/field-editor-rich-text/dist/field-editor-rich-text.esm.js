...
import { EditorToolbarButton, EntryCard, AssetCard, Modal, Button, Form, TextField, SelectField, Option, FormLabel, TextLink, Tag, Tooltip, DropdownListItem, Dropdown, DropdownList, Flex, Icon, InlineEntryCard, SectionHeading, IconButton, Spinner, SkeletonContainer, SkeletonBodyText, InViewport, EditorToolbar, EditorToolbarDivider } from '@contentful/forma-36-react-components';
...
var EntityLinkToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return this.props.isButton ? /*#__PURE__*/React__default.createElement(Button, {
      ...
      icon: type === 'Asset' ? 'Asset' : 'EmbeddedEntryBlock',
      className: "rich-text__embedded-entry-list-icon " + styles$5.icon,
      color: "secondary"
...
var EntryLinkToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return this.props.isButton ? /*#__PURE__*/React__default.createElement(Button, {
      ...
      icon: "EmbeddedEntryInline",
      color: "secondary",
      className: "rich-text__embedded-entry-list-icon " + styles$7.icon
...
var FetchingWrappedInlineEntryCard = function FetchingWrappedInlineEntryCard(props) {
  ...
  return /*#__PURE__*/React__default.createElement(InlineEntryCard, {
    ...
    className: styles$8.scheduledIcon,
    icon: "Clock",
    color: "muted",
    ...
    renderNode: function renderNode(props, _editor, next) {
      if (props.node.type === BLOCKS.HR) {
        return /*#__PURE__*/React__default.createElement("hr", Object.assign({
          className: cx(styles$9.hr, props.isSelected && styles$9.hrSelected)
        }, props.attributes));
      }
...
var Instruction = function Instruction(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("span", {
    className: styles$a.instruction
  }, children);
};
...
var CommandPanel = /*#__PURE__*/function (_React$Component2) {
  ...
  function CommandPanel() {
    ...
    _this3.renderStatusBar = function () {
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        className: styles$a.instructions
    ...
    _this3.renderSkeleton = function () {
      return /*#__PURE__*/React__default.createElement("li", {
        className: styles$a.skeletonContainer
  ...
  _proto2.renderItems = function renderItems(groupName) {
    ...
    return this.state.items.filter(function (item) {
      ...
      var classNames = cn(styles$a.item, (_cn = {}, _cn[styles$a.isSelected] = isSelected, _cn));
  ...
  _proto2.render = function render() {
    ...
    var classNames = cn(styles$a.commandPanel, className);
    return /*#__PURE__*/React__default.createElement("div", {
      className: classNames
    }, this.renderNavigationBar(), /*#__PURE__*/React__default.createElement("ul", {
      className: styles$a.commandPanelList,
      "data-test-id": testId
...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  function Toolbar() {
    ...
    _this.renderEmbeds = function (props) {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        className: styles$b.embedActionsWrapper
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(EditorToolbar, {
      ...
      className: styles$b.formattingOptionsWrapper
...
var StickyToolbarWrapper = function StickyToolbarWrapper(_ref) {
  var isDisabled = _ref.isDisabled,
      children = _ref.children;
  return /*#__PURE__*/React__default.createElement("div", {
    className: isDisabled ? '' : styles$c.nativeSticky
  }, children);
};
...
var ConnectedRichTextEditor = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    var classNames = cx(styles$d.editor, this.props.minHeight !== undefined ? css({
      minHeight: this.props.minHeight
    }) : undefined, this.props.isDisabled ? styles$d.disabled : styles$d.enabled, this.props.isToolbarHidden && styles$d.hiddenToolbar);
    return /*#__PURE__*/React__default.createElement("div", {
