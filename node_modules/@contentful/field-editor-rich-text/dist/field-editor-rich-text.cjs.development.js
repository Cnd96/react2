    ...
    renderNode: function renderNode(props, _editor, next) {
      if (props.node.type === richTextTypes.BLOCKS.HR) {
        return /*#__PURE__*/React__default.createElement("hr", Object.assign({
          className: emotion.cx(styles$9.hr, props.isSelected && styles$9.hrSelected)
        }, props.attributes));
      }
...
var ConnectedRichTextEditor = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    var classNames = emotion.cx(styles$d.editor, this.props.minHeight !== undefined ? emotion.css({
